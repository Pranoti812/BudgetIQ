...
// // // // // import 'package:budegt_iq/view/bottom_nav.dart';
// // // // // import 'package:budegt_iq/view/upload_service.dart';
// // // // // import 'package:budegt_iq/view/region.dart'; // 🔥 ADDED IMPORT
// // // // // import 'package:fl_chart/fl_chart.dart';
// // // // // import 'package:flutter/material.dart';
// // // // // import 'package:cloud_firestore/cloud_firestore.dart';
...
// // // // //                         var data = snapshot.data as Map<String, dynamic>;
// // // // //                         Map<String, double> percentages = data['percentages'];
// // // // //                         List keys = data['keys'];
...
// // // // //                         return Column(
// // // // //                           children: List.generate((count / 2).ceil(), (
// // // // //                             rowIndex,
// // // // //                           ) {
// // // // //                             int i = rowIndex * 2;
...
// // // // //               /// 🔥 GRADIENT BUTTON — navigates to RegionAnalysisPage
// // // // //               GestureDetector(
// // // // //                 onTap: () {
// // // // //                   Navigator.push(
// // // // //                     context,
// // // // //                     MaterialPageRoute(
// // // // //                       builder: (context) => const RegionAnalysisPage(),
// // // // //                     ),
// // // // //                   );
// // // // //                 },
// // // // //                 child: Container(
...
// // // // //                     borderRadius: BorderRadius.circular(20),
// // // // //                     gradient: const LinearGradient(
// // // // //                       colors: [Color(0xff14b8b0), Color(0xff00d641)],
// // // // //                     ),
// // // // //                   ),
// // // // //                   child: const Center(
// // // // //                     child: Text(
...
// // // // //                   color: Colors.white,
// // // // //                   borderRadius: BorderRadius.circular(20),
// // // // //                   border: Border.all(color: Color(0xffb8f2e5), width: 1.2),
// // // // //                   boxShadow: [
// // // // //                     BoxShadow(
// // // // //                       blurRadius: 10,
// // // // //                       color: Colors.black12,
...
// // // // //         currentIndex: currentIndex,
// // // // //         onTap: (index) {
// // // // //           // 🔥 NAVIGATE TO REGION SCREEN WHEN REGIONS TAB (index 1) IS TAPPED
// // // // //           if (index == 1) {
// // // // //             Navigator.push(
// // // // //               context,
// // // // //               MaterialPageRoute(
...
// // // // import 'package:budegt_iq/view/compare.dart'; // 🔥 ADDED IMPORT
// // // // import 'package:fl_chart/fl_chart.dart';
// // // // import 'package:flutter/material.dart';
// // // // import 'package:cloud_firestore/cloud_firestore.dart';
...
// // // //         currentIndex: currentIndex,
// // // //         onTap: (index) {
// // // //           // 🔥 INDEX 1 → Regions, INDEX 2 → Compare
// // // //           if (index == 1) {
// // // //             Navigator.push(
// // // //               context,
// // // //               MaterialPageRoute(
...
// // // //             );
// // // //           } else if (index == 2) {
// // // //             // 🔥 NAVIGATE TO COMPARE SCREEN WHEN COMPARE TAB IS TAPPED
// // // //             Navigator.push(
// // // //               context,
// // // //               MaterialPageRoute(
// // // //                 builder: (context) => const CompareRegionsPage(),
// // // //               ),
// // // //             );
// // // //           } else {
// // // //             setState(() {
...
// // //             );
// // //           } else if (index == 2) {
// // //             // 🔥 NAVIGATE TO COMPARE SCREEN WHEN COMPARE TAB (index 2) IS TAPPED
// // //             Navigator.push(
// // //               context,
// // //               MaterialPageRoute(
// // //                 builder: (context) => const CompareRegionsPage(),
...
// // import 'package:budegt_iq/view/profile.dart'; // 🔥 ADDED IMPORT
// // import 'package:fl_chart/fl_chart.dart';
// // import 'package:flutter/material.dart';
// // import 'package:cloud_firestore/cloud_firestore.dart';
...
// //             );
// //           } else if (index == 4) {
// //             // 🔥 NAVIGATE TO PROFILE SCREEN WHEN PROFILE TAB (index 4) IS TAPPED
// //             Navigator.push(
// //               context,
// //               MaterialPageRoute(
...
// //import 'package:budegt_iq/AI_assistant/voice_assistant.dart'; // 🔥 ADDED IMPORT
// import 'package:fl_chart/fl_chart.dart';
// import 'package:flutter/material.dart';
// import 'package:cloud_firestore/cloud_firestore.dart';
...
//               /// WHITE BUTTON — navigates to VoiceAssistant (AI Chat)
//               GestureDetector(
//                 onTap: () {
//                   // 🔥 NAVIGATE TO VOICE ASSISTANT WHEN "Ask AI Assistant" BUTTON IS TAPPED
//                   Navigator.push(
//                     context,
//                     MaterialPageRoute(
...
//             );
//           } else if (index == 3) {
//             // 🔥 NAVIGATE TO AI CHAT SCREEN WHEN AI CHAT TAB (index 3) IS TAPPED
//             Navigator.push(
//               context,
...
class _CitizenHomeScreenState extends State<CitizenHomeScreen> {
  ...
  // 🔥 Helper: navigate to VoiceAssistant, passing the API key safely
  void _navigateToAIAssistant() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => VoiceAssistant(apiKey: apiKey)),
    );
  }
            ...
            children: [
                  ...
                  children: [
                    ...
                    FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List keys = data['keys'];
                        final colors = [
                          const Color(0xff18b9ab),
                          const Color(0xff17c455),
                          const Color(0xff2f77f6),
                          const Color(0xff9b52f2),
                        ];
                        int count = keys.length > 4 ? 4 : keys.length;
                        return SizedBox(
                          height: 280,
              ...
              FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  final colors = [
                    const Color(0xff12b8aa),
                    const Color(0xff18c54e),
                    const Color(0xff2f77f6),
                  ];
                  return Row(
                    children: List.generate(count, (index) {
              ...
              /// GRADIENT BUTTON — View Region Insights
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
      ...
      bottomNavigationBar: CustomBottomNavBar(
        ...
        onTap: (index) {
          if (index == 1) {
            ...
            // 🔥 AI Chat tab (index 3) → navigate to VoiceAssistant
